...
export const ModelsSettings: React.FC = () => {
  ...
  // A cloud engine makes the local catalog inert: nothing below this point
  // affects transcription until the engine is switched back.
  ...
  return (
    <div className="max-w-3xl w-full mx-auto space-y-4">
      ...
      {cloudEnabled && (
        <p className="text-sm text-text/60">
          {t("settings.transcriptionEngine.localInactive")}
        </p>
      )}

      <div
        className={
          cloudEnabled ? "opacity-40 pointer-events-none select-none" : ""
        }
      >
